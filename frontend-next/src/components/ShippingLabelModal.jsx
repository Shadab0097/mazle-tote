...
const ShippingLabelModal = ({ isOpen, onClose, order }) => {
    ...
    const companyName = process.env.NEXT_PUBLIC_COMPANY_NAME || "Mazel Tote";
    const companyAddress1 = process.env.NEXT_PUBLIC_COMPANY_ADDRESS_LINE1 || "5500 North Military";
    const companyAddress2 = process.env.NEXT_PUBLIC_COMPANY_ADDRESS_LINE2 || "Trail Boca Raton, FL 33496";
