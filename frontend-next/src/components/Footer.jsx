                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 mb-8 md:mb-10">
                    ...
                    <div className="col-span-1 pl-9 md:pl-0">
                        ...
                        <ul className="space-y-2 text-xs text-gray-500 font-medium">
                            <li><Link href="/products" onClick={scrollToTop} className="hover:text-[var(--color-primary)] transition-colors">All Products</Link></li>
                            <li><Link href="/products" onClick={scrollToTop} className="hover:text-[var(--color-primary)] transition-colors">New Arrivals</Link></li>
                            <li><Link href="/products" onClick={scrollToTop} className="hover:text-[var(--color-primary)] transition-colors">Accessories</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="col-span-1 pl-9 md:pl-0">
                        ...
                        <ul className="space-y-2 text-xs text-gray-500 font-medium">
                            <li><Link href="/about" onClick={scrollToTop} className="hover:text-[var(--color-primary)] transition-colors">Our Story</Link></li>
                            <li><Link href="/contact" onClick={scrollToTop} className="hover:text-[var(--color-primary)] transition-colors">Contact</Link></li>
                            <li><Link href="/privacy" onClick={scrollToTop} className="hover:text-[var(--color-primary)] transition-colors">Privacy Policy</Link></li>
                        </ul>
                    </div>
