...
const Register = () => {
  ...
  }, [isAuthenticated, error, router, dispatch, toast]);
      ...
      <div className="w-full max-w-md mx-auto lg:mx-0 relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700 bg-white p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-white">
          ...
          <div className="flex items-start gap-2 text-sm pt-2">
            ...
            >
              ...
              <span className="leading-tight">
                I agree to the <Link href="/terms" className="text-[#2C2C2C] font-bold hover:underline" onClick={e => e.stopPropagation()}>Terms of Service</Link> and <Link href="/privacy" className="text-[#2C2C2C] font-bold hover:underline" onClick={e => e.stopPropagation()}>Privacy Policy</Link>
              </span>
            </label>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 text-center lg:text-left">
          <p className="text-gray-500 font-medium">
            ...
            <Link href="/login" className="text-[#2C2C2C] font-bold hover:text-[#8ABEE8] transition-colors border-b-2 border-[#2C2C2C] hover:border-[#8ABEE8] pb-0.5">
              Sign In
            </Link>
          </p>
        </div>
